...
#        print('Unknown Android version!\n')
    ...
    try:
        ...
        print('Converting android sparse data image "{}" into filesystem raw image "{}"'.format(os.path.basename(NEW_DATA_FILE), os.path.basename(OUTPUT_IMAGE_FILE)), flush=True)
    except IOError as e:
